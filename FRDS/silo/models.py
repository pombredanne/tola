...
class ValueStoreAdmin(admin.ModelAdmin):
	list_display = ('column','value_type','int_store','char_store','text_store','date_store','create_date','edit_date')
	display = 'Stored Values'

class DataValue(models.Model):
	silo = models.ForeignKey(Silo)
	column = models.ForeignKey(DataField)
	value_store = models.ForeignKey(ValueStore)
	create_date = models.DateTimeField(null=True, blank=True)
	edit_date = models.DateTimeField(null=True, blank=True)

class DataValueAdmin(admin.ModelAdmin):
	list_display = ('silo','column','value_store','create_date','edit_date')
	display = 'Data Field Values'
